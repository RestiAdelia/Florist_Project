...
<body class="bg-gray-100 font-sans antialiased">
    <div class="flex h-screen">
        <aside
            class="group bg-teal-700 text-white flex flex-col h-screen w-20 hover:w-64 transition-all duration-300 flex-shrink-0 overflow-hidden">
            ...
            <div class="px-6 py-5 flex items-center h-16 whitespace-nowrap">
                ...
                <span
                    class="hidden group-hover:block text-xl font-bold opacity-0 group-hover:opacity-100 transition-all duration-500 delay-100">
                    Aurora Florist
                </span>
            </div>
            ...
            <nav class="flex-1 mt-4 space-y-2 px-2 overflow-y-auto custom-scrollbar">
                <a href="{{ route('dashboard') }}"
                    ...
                    <span
                        class="opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap font-medium text-sm">
                        Dashboard
                    </span>
                </a>
