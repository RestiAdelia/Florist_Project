...
<section class="px-6 py-20">
    <div class="container mx-auto max-w-4xl">
        <h1 class="text-4xl font-extrabold text-pink-600 mb-6">Langkah-langkah Pemesanan</h1>
        ...
        <a href="{{ url('/') }}"
           class="mt-8 inline-block px-8 py-4 bg-pink-600 text-white rounded-xl shadow-lg font-semibold hover:bg-pink-700 transition">
           Kembali ke Beranda
        </a>
    </div>
</section>
